...
public class Utility {
    ...
    public static Iterator<Map.Entry<String, Double>> valueIteratorReverse(Map<String, Double> map) {
    ...
    public static Iterator<Map.Entry<String, Double>> valueIterator(Map<String, Double> map) {
        Set set = new TreeSet(new Comparator<Map.Entry<String, Double>>() {
            public int compare(Map.Entry<String, Double> o1, Map.Entry<String, Double> o2) {
                return  o1.getValue().compareTo(o2.getValue()) > 0 ? -1 : 1;
            }
